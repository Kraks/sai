...
class Playground extends TestLLSC {
  ...
  testLLSC(new PureLLSC, List(TestPrg(true_linked, "true_linked_posix", "@main", useArgv, "--argv=./true.bc --sym-arg 3", nPath(16)++status(0))))
  testLLSC(new PureLLSC, List(TestPrg(true_llsc_linked, "true_llsc_linked", "@main", useArgv, "--argv=./true.bc #{3}", nPath(16)++status(0))))
  ...
  testLLSC(new PureLLSC, List(TestPrg(echo_linked, "echo_linked_posix", "@main", useArgv, "--argv=./true.bc --sym-arg 3", nPath(10)++status(0))))
  testLLSC(new PureLLSC, List(TestPrg(echo_llsc_linked, "echo_llsc_linked", "@main", useArgv, "--argv=./true.bc #{3}", nPath(16)++status(0))))
