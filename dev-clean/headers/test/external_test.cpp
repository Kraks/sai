...
int x9 = std::make_shared<File>("B")->content.size();
/* assertEq */;
...
/* testReadStatField */;
Ptr<File> x63 = std::make_shared<File>("A");
...
FS x82 = FS();
Ptr<File> x83 = std::make_shared<File>("a");
/* setFile */;
...
Ptr<File> x99 = std::make_shared<File>("b");
/* setFile */;
...
Ptr<File> x115 = std::make_shared<File>("c");
/* setFile */;
...
Ptr<File> x232 = std::make_shared<File>("c", immer::flex_vector<PtrVal>{intV_0, intV_1, intV_2});
/* setFile */;
...
Ptr<Stream> x266 = std::make_shared<Stream>(x259, x251->mode, x251->cursor);
...
Ptr<File> x292 = std::make_shared<File>("d");
/* setFile */;
...
Ptr<File> x344 = std::make_shared<File>("c", immer::flex_vector<PtrVal>{intV_0, intV_1, intV_2});
/* setFile */;
...
Ptr<Stream> x368 = std::make_shared<Stream>(x361, O_RDONLY, 1L);
...
Ptr<Stream> x389 = std::make_shared<Stream>(x382, x374->mode, x374->cursor);
...
Ptr<Stream> x419 = std::make_shared<Stream>(x412, O_RDONLY, 0L);
